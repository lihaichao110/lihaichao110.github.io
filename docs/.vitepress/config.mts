...
import { clientSidebar, offerSidebar, serverSidebar } from '../script/clientSidebar'
...
export default defineConfig({
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: 'offer 指南 🌌', link: '/offer/网络/https协议' },
    ],
    ...
    socialLinks: [
      ...
      },
      {
        ...
        link: 'https://www.douyin.com/search/%E9%B8%AD%E6%9D%8E%E5%A4%A7'
      }
    ],
    footer: {
